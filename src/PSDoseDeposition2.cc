...
PSDoseDeposition2::PSDoseDeposition2(G4String name,
				     G4int ni, G4int nj, G4int nk,
				     G4int di, G4int dj, G4int dk)
:PSDoseDeposition2Core(name),
...
PSDoseDeposition2::~PSDoseDeposition2()
{
  ;
}

G4int PSDoseDeposition2::GetIndex(G4Step* aStep)//overwrite super-super class method
{
